...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "text-muted-foreground inline-flex h-12 w-fit items-center justify-center gap-4 border-b-2 border-gray-200",
        className,
      )}
      {...props}
    />
